 ...
 * __COMPILER_LANGUAGE_STANDARD_CPP2017	-> C++17 - ISO/IEC 14882:2017
 */
...
#define __COMPILER_LANGUAGE_STANDARD_CPP2017	201703L
#define __COMPILER_LANGUAGE_STANDARD_STRING	(																				\
	...
	(__COMPILER_LANGUAGE_STANDARD <= __COMPILER_LANGUAGE_STANDARD_CPP2017) ? _T("ISO C++17") : (						\
	_T("Unknown")))))))))																									\
)
...
#define __COMPILER_CPU_BYTE_ORDER_STRING	(														 \
	...
	(__COMPILER_CPU_BYTE_ORDER == __COMPILER_CPU_BYTE_ORDER_WSLE_ENDIAN) ? _T("PDP-Endian") : ( 	 \
	(__COMPILER_CPU_BYTE_ORDER == __COMPILER_CPU_BYTE_ORDER_WSBE_ENDIAN) ? _T("Honeywell-Endian") : (	 \
	_T("Unknown")))))																				 \
)
